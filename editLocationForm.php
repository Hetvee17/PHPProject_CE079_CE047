        ...
        <div class="content">
            <div class="container">
                ...
                <form action="editLocation.php" method="POST" class="form-horizontal">
                    <input type="hidden" name="id" value="<?php echo $row['locationID']; ?>" /><!--auto incremented cannot be updated from website-->
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <span id="LNameError" class="error"></span><!--invalid input-->
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <span id="LAddressError" class="error"></span><!--error-->
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <span id="mNameError" class="error"></span><!--invalid input-->
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <span id="mNameError" class="error"></span><!--input-->
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <span id="mEmailError" class="error"></span><!--invalid input-->
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <span id="mNumError" class="error"></span><!-- invalid input-->
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <span id="capError" class="error"></span><!--invalid input-->
                        </div>
                    </div>
